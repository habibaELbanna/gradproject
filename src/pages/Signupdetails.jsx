        ...
        <form className="auth__form" onSubmit={handleSubmit}>
          ...
          <div className="auth__field">
            ...
            <div className="auth__input-wrap">
              ...
              <input className="auth__input" type={showPass ? 'text' : 'password'} name="password" placeholder="Enter password" value={form.password} onChange={handleChange} />
          ...
          <div className="auth__field">
            ...
            <div className="auth__input-wrap">
              <svg className="auth__icon" width="18" height="18" viewBox="0 0 24 24" fill="none"><rect x="3" y="11" width="18" height="11" rx="2" stroke="currentColor" strokeWidth="1.5"/><path d="M7 11V7a5 5 0 0110 0v4" stroke="currentColor" strokeWidth="1.5"/></svg>
              <input className="auth__input" type={showConfirm ? 'text' : 'password'} name="confirm" placeholder="Re-enter password" value={form.confirm} onChange={handleChange} />
