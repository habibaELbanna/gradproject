...
export default function SignupProfile() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    if (!form.agreed) { setError('Please agree to Terms of Service'); return; }
        ...
        <form className="auth__form" onSubmit={handleSubmit}>
          <div className="auth__field">
            ...
            <div className="auth__input-wrap">
              ...
              <input className="auth__input" name="fullName" placeholder="Ahmed Mohamed" value={form.fullName} onChange={handleChange} required />
            </div>
          </div>
          ...
          <div className="auth__field">
            ...
            <div className="auth__input-wrap">
              ...
              <input className="auth__input" name="company" placeholder="Your Company Ltd." value={form.company} onChange={handleChange} required />
            </div>
          </div>
          ...
          <div className="auth__field">
            ...
            <div className="auth__input-wrap">
              ...
              <select className="auth__input auth__select" name="industry" value={form.industry} onChange={handleChange} required>
          ...
          <div className="auth__field">
            ...
            <div className="auth__phone-wrap">
              ...
              <div className="auth__input-wrap auth__phone-num">
                ...
                <input className="auth__input" name="phone" placeholder="123 456 7890" value={form.phone} onChange={handleChange} required />
              </div>
            </div>
          </div>
