...
export default function Preloader({ onFinish }) {
  ...
  return (
    <div className={`pre__wrap ${phase === 'fadeout' ? 'pre__wrap--out' : ''}`}>
      <div className="pre__content">

        <div className={`pre__logo-wrap ${phase !== 'enter' ? 'pre__logo-wrap--visible' : ''}`}>
          <svg width="108" height="38" viewBox="0 0 54 19" fill="none" xmlns="http://www.w3.org/2000/svg" className="pre__logo-svg">
        ...
        <div className={`pre__bird-wrap ${phase === 'fly' || phase === 'fadeout' ? 'pre__bird-wrap--fly' : ''}`}>
          <svg width="74" height="38" viewBox="0 0 37 19" fill="none" xmlns="http://www.w3.org/2000/svg" className="pre__bird-svg">
        ...
        <div className="pre__bar">
          <div className={`pre__bar-fill ${phase !== 'enter' ? 'pre__bar-fill--run' : ''}`} />
        </div>
